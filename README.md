[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=18373347&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
Addressed the software crisis, where projects faced delays, cost overruns, and failures due to lack of structured development processes.
Led to the adoption of systematic methodologies and best practices.

b)The Rise of Structured Programming (1970s-1980s)

Introduced programming paradigms like structured programming (e.g., using loops and conditionals instead of GOTO statements).
Promoted modular code, improving readability, maintainability, and reducing bugs.
Key figures: Edsger Dijkstra, who advocated for structured programming principles.

c)Agile Revolution & DevOps (2001 - Present)

The Agile Manifesto (2001) emphasized flexibility, collaboration, and iterative development over rigid, document-heavy processes.
DevOps (2010s) bridged the gap between development and IT operations, enabling faster, automated software delivery.
Led to practices like continuous integration, continuous deployment (CI/CD), and cloud-based software engineering.
